...
<template>
    <TableTemplate>
        <template #filters>
            ...
            <div>
                <ListFilter v-model:label="schoolLabel" v-model:selected="selectedSchool" v-model:types="schools">
                </ListFilter>
            </div>
        ...
        <template #disclosure>
            <Disclosure v-slot="{ open }">
                <DisclosurePanel class="grid w-full grid-cols-5 gap-4 mt-4">
                    <div>
                        <ListFilter :label="'Components'" v-model:selected="selectedComp" v-model:types="components">
                        </ListFilter>
                    </div>
                    <div>
